...
class Search(Tk):
    def __init__(self):
        ...
        f = StringVar()
        g = StringVar()
        self.title("Ogrenci Ara")
        self.maxsize(800,520)
        self.canvas = Canvas(width=1366, height=768, bg='gray')
        self.canvas.pack()
        self.iconbitmap(r'libico.ico')
        l1=Label(self,text="Ogrenci Ara",bg='gray', font=("Courier new",20,'bold')).place(x=290,y=40)
        l = Label(self, text="Aranacak Kriter",bg='gray', font=("Courier new", 15, 'bold')).place(x=70, y=100)
        ...
        self.b= Button(self,text="Bul",width=8,font=("Courier new",8,'bold'),command= ge )
        ...
        self.la = Label(self, text="Girin",bg = 'gray', font=("Courier new", 15, 'bold')).place(x=70, y=140)
        ...
        self.listTree.heading("#0", text='Ogrenci ID', anchor='w')
        self.listTree.column("#0", width=100, anchor='w')
        self.listTree.heading("Student Name", text='Ogrenci Adi')
        self.listTree.column("Student Name", width=200, anchor='center')
        self.listTree.heading("Phone Number", text='Numara')
        self.listTree.column("Phone Number", width=200, anchor='center')
        self.listTree.heading("Address", text='Adres')
